...
public data class Annotation(
  ...
  public sealed interface Author : FhirChoice {
    ...
    public data class Reference(override val `value`: dev.ohs.fhir.model.r5.Reference) : Author

    public data class String(override val `value`: dev.ohs.fhir.model.r5.String) : Author
