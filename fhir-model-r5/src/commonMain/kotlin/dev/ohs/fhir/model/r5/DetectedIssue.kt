...
public data class DetectedIssue(
  ...
  public sealed interface Identified : FhirChoice {
    ...
    public data class DateTime(override val `value`: dev.ohs.fhir.model.r5.DateTime) : Identified

    public data class Period(override val `value`: dev.ohs.fhir.model.r5.Period) : Identified
