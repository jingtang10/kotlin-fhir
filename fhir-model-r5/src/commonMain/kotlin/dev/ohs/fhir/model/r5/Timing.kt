...
public data class Timing(
  ...
  public data class Repeat(
    ...
    public sealed interface Bounds : FhirChoice {
      ...
      public data class Duration(override val `value`: dev.ohs.fhir.model.r5.Duration) : Bounds

      public data class Range(override val `value`: dev.ohs.fhir.model.r5.Range) : Bounds

      public data class Period(override val `value`: dev.ohs.fhir.model.r5.Period) : Bounds
