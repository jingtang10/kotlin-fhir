...
public data class Specimen(
  ...
  public data class Processing(
    ...
    public sealed interface Time : FhirChoice {
      ...
      public data class DateTime(override val `value`: dev.ohs.fhir.model.r5.DateTime) : Time

      public data class Period(override val `value`: dev.ohs.fhir.model.r5.Period) : Time
