...
public data class RiskAssessment(
  ...
  public data class Prediction(
    ...
    public sealed interface Probability : FhirChoice {
      ...
      public data class Decimal(override val `value`: dev.ohs.fhir.model.r5.Decimal) : Probability

      public data class Range(override val `value`: dev.ohs.fhir.model.r5.Range) : Probability
    ...
    public sealed interface When : FhirChoice {
      ...
      public data class Range(override val `value`: dev.ohs.fhir.model.r5.Range) : When
