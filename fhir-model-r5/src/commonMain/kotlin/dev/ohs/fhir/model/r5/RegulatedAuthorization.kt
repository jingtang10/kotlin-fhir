...
public data class RegulatedAuthorization(
  ...
  public data class Case(
    ...
    public sealed interface Date : FhirChoice {
      ...
      public data class Period(override val `value`: dev.ohs.fhir.model.r5.Period) : Date

      public data class DateTime(override val `value`: dev.ohs.fhir.model.r5.DateTime) : Date
