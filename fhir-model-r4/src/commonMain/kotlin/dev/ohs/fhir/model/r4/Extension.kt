...
public data class Extension(
  ...
  public sealed interface Value : FhirChoice {
    ...
    public data class Base64Binary(override val `value`: dev.ohs.fhir.model.r4.Base64Binary) : Value
    ...
    public data class ContactPoint(override val `value`: dev.ohs.fhir.model.r4.ContactPoint) : Value
    ...
    public data class UsageContext(override val `value`: dev.ohs.fhir.model.r4.UsageContext) : Value
