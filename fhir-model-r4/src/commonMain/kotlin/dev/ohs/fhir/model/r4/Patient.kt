...
public data class Patient(
  ...
  public sealed interface Deceased : FhirChoice {
    ...
    public data class DateTime(override val `value`: dev.ohs.fhir.model.r4.DateTime) : Deceased
  ...
  public sealed interface MultipleBirth : FhirChoice {
    ...
    public data class Boolean(override val `value`: dev.ohs.fhir.model.r4.Boolean) : MultipleBirth

    public data class Integer(override val `value`: dev.ohs.fhir.model.r4.Integer) : MultipleBirth
