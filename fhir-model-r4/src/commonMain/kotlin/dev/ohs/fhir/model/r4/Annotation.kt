...
public data class Annotation(
  ...
  public sealed interface Author : FhirChoice {
    ...
    public data class Reference(override val `value`: dev.ohs.fhir.model.r4.Reference) : Author

    public data class String(override val `value`: dev.ohs.fhir.model.r4.String) : Author
