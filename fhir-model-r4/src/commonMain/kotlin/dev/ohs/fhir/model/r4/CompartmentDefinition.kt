...
import dev.ohs.fhir.model.r4.serializers.CompartmentDefinitionResourceSerializer
...
public data class CompartmentDefinition(
   ...
   * labels.
   */
  override val contained: List<dev.ohs.fhir.model.r4.Resource> = listOf(),
  /**
  ...
  public class Builder(
     ...
     * labels.
     */
    public var contained: MutableList<dev.ohs.fhir.model.r4.Resource.Builder> = mutableListOf()
