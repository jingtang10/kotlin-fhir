...
public data class MedicationRequest(
  ...
  public data class Substitution(
    ...
    public sealed interface Allowed : FhirChoice {
      ...
      public data class Boolean(override val `value`: dev.ohs.fhir.model.r4.Boolean) : Allowed
  ...
  public sealed interface Reported : FhirChoice {
    ...
    public data class Boolean(override val `value`: dev.ohs.fhir.model.r4.Boolean) : Reported

    public data class Reference(override val `value`: dev.ohs.fhir.model.r4.Reference) : Reported
