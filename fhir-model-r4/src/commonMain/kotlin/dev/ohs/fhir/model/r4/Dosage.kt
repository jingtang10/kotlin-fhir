...
public data class Dosage(
  ...
  public data class DoseAndRate(
    ...
    public sealed interface Dose : FhirChoice {
      ...
      public data class Range(override val `value`: dev.ohs.fhir.model.r4.Range) : Dose

      public data class Quantity(override val `value`: dev.ohs.fhir.model.r4.Quantity) : Dose
    ...
    public sealed interface Rate : FhirChoice {
      ...
      public data class Ratio(override val `value`: dev.ohs.fhir.model.r4.Ratio) : Rate

      public data class Range(override val `value`: dev.ohs.fhir.model.r4.Range) : Rate

      public data class Quantity(override val `value`: dev.ohs.fhir.model.r4.Quantity) : Rate
  ...
  public sealed interface AsNeeded : FhirChoice {
    ...
    public data class Boolean(override val `value`: dev.ohs.fhir.model.r4.Boolean) : AsNeeded
