...
public data class Media(
  ...
  public sealed interface Created : FhirChoice {
    ...
    public data class DateTime(override val `value`: dev.ohs.fhir.model.r4b.DateTime) : Created

    public data class Period(override val `value`: dev.ohs.fhir.model.r4b.Period) : Created
