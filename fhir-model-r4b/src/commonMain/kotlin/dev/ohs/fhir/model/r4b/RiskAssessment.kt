...
public data class RiskAssessment(
  ...
  public data class Prediction(
    ...
    public sealed interface Probability : FhirChoice {
      ...
      public data class Decimal(override val `value`: dev.ohs.fhir.model.r4b.Decimal) : Probability

      public data class Range(override val `value`: dev.ohs.fhir.model.r4b.Range) : Probability
    ...
    public sealed interface When : FhirChoice {
      ...
      public data class Period(override val `value`: dev.ohs.fhir.model.r4b.Period) : When

      public data class Range(override val `value`: dev.ohs.fhir.model.r4b.Range) : When
