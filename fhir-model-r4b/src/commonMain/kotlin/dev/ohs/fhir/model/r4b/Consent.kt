...
public data class Consent(
  ...
  public sealed interface Source : FhirChoice {
    ...
    public data class Attachment(override val `value`: dev.ohs.fhir.model.r4b.Attachment) : Source

    public data class Reference(override val `value`: dev.ohs.fhir.model.r4b.Reference) : Source
