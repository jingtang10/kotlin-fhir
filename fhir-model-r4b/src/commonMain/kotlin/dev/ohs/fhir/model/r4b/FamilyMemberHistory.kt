...
public data class FamilyMemberHistory(
  ...
  public sealed interface Born : FhirChoice {
    ...
    public data class Period(override val `value`: dev.ohs.fhir.model.r4b.Period) : Born

    public data class Date(override val `value`: dev.ohs.fhir.model.r4b.Date) : Born

    public data class String(override val `value`: dev.ohs.fhir.model.r4b.String) : Born
  ...
  public sealed interface Age : FhirChoice {
    ...
    public data class Age(override val `value`: dev.ohs.fhir.model.r4b.Age) :
      FamilyMemberHistory.Age

    public data class Range(override val `value`: dev.ohs.fhir.model.r4b.Range) :
      FamilyMemberHistory.Age
  ...
  public sealed interface Deceased : FhirChoice {
    ...
    public data class Boolean(override val `value`: dev.ohs.fhir.model.r4b.Boolean) : Deceased

    public data class Age(override val `value`: dev.ohs.fhir.model.r4b.Age) : Deceased

    public data class Range(override val `value`: dev.ohs.fhir.model.r4b.Range) : Deceased

    public data class Date(override val `value`: dev.ohs.fhir.model.r4b.Date) : Deceased

    public data class String(override val `value`: dev.ohs.fhir.model.r4b.String) : Deceased
