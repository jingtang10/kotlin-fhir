...
public data class Provenance(
  ...
  public sealed interface Occurred : FhirChoice {
    ...
    public data class Period(override val `value`: dev.ohs.fhir.model.r4b.Period) : Occurred

    public data class DateTime(override val `value`: dev.ohs.fhir.model.r4b.DateTime) : Occurred
