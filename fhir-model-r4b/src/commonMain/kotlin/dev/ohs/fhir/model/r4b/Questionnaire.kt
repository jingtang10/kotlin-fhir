  ...
  public data class Item(
    ...
    public data class EnableWhen(
      ...
      public sealed interface Answer : FhirChoice {
        ...
        public data class Boolean(override val `value`: dev.ohs.fhir.model.r4b.Boolean) : Answer

        public data class Decimal(override val `value`: dev.ohs.fhir.model.r4b.Decimal) : Answer

        public data class Integer(override val `value`: dev.ohs.fhir.model.r4b.Integer) : Answer

        public data class Date(override val `value`: dev.ohs.fhir.model.r4b.Date) : Answer

        public data class DateTime(override val `value`: dev.ohs.fhir.model.r4b.DateTime) : Answer

        public data class Time(override val `value`: dev.ohs.fhir.model.r4b.Time) : Answer

        public data class String(override val `value`: dev.ohs.fhir.model.r4b.String) : Answer

        public data class Coding(override val `value`: dev.ohs.fhir.model.r4b.Coding) : Answer

        public data class Quantity(override val `value`: dev.ohs.fhir.model.r4b.Quantity) : Answer

        public data class Reference(override val `value`: dev.ohs.fhir.model.r4b.Reference) : Answer
